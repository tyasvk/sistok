...
<template>
    <Head title="Edit Profil - Sistok Lapas" />
        ...
        <aside :class="isSidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed md:relative z-30 w-64 h-full bg-[#0F172A] text-white flex flex-col flex-shrink-0 transition-transform duration-300 ease-in-out md:translate-x-0">
           ...
           <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            <div class="p-4 border-t border-gray-800">
                <div class="flex items-center w-full px-4 py-3 mb-2 bg-gray-800 text-white rounded-xl shadow-inner font-medium">
                    <svg class="w-5 h-5 mr-3 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                    Profil Saya
                </div>
        ...
        <div class="flex-1 flex flex-col h-screen overflow-hidden w-full">
            <header class="h-16 md:h-20 bg-white flex items-center justify-between px-4 md:px-8 border-b border-gray-200 shrink-0">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg md:text-2xl font-bold text-gray-800">Pengaturan Profil</h2>
                </div>
            ...
            <main class="flex-1 overflow-y-auto p-4 md:p-8">
                <div class="max-w-4xl mx-auto space-y-6">
                    ...
                    <div class="p-6 md:p-8 bg-white shadow-sm border border-gray-100 rounded-3xl">
                    ...
                    <div class="p-6 md:p-8 bg-red-50 shadow-sm border border-red-100 rounded-3xl">
